...
namespace MoreMountains.Tools
{
    ...
    /// </summary>
    [ExecuteAlways]
    public class CCTilemapGenerator : MonoBehaviour
    {
        [Header("Grid")]
        ...
        public GameObject CoinPicker;
        public GameObject Ninga;
        ...
        protected virtual void GenerateLayer(MMTilemapGeneratorLayer layer,ArrayData arrayData)
        {
            if (!layer.Active)
            {
                return;
            ...
            width = arrayData.GetWidth();
            height = arrayData.GetHeight();
            ...
            switch (layer.GenerateMethod)
            {
                ...
                case MMTilemapGenerator.GenerateMethods.RandomWalk:
                    ...
                    layer.Grid = _grid;
                    break;
                case MMTilemapGenerator.GenerateMethods.RandomWalkAvoider:
                    ...
                    layer.Grid = _grid;
                    break;
                case MMTilemapGenerator.GenerateMethods.RandomWalkGround:
                    ...
                    layer.Grid = _grid;
                    break;
                case MMTilemapGenerator.GenerateMethods.Path:
                    ...
                    layer.Grid = _grid;
                    break;
                case MMTilemapGenerator.GenerateMethods.Copy:
